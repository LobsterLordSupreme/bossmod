...
public class UnnaturalDoubleChestScreenHandler extends ScreenHandler {
    private static final int rows = 8;
    private final Inventory inventory;

    public UnnaturalDoubleChestScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, new SimpleInventory(rows*9));
    }

    public UnnaturalDoubleChestScreenHandler(int i, PlayerInventory playerInventory, Inventory inventory) {
        super(Bossmod.UNNATURAL_DOUBLE_CHEST_SCREEN_HANDLER, i);
